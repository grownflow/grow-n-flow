...
import type { SyncInfo, FilteredMetadata, Game, State, ActionShape, CredentialedActionShape, LogEntry, PlayerID, ChatMessage } from 'boardgame.io';
import type { Auth } from 'boardgame.io/dist/types/src/server/auth';
import * as StorageAPI from 'boardgame.io/dist/types/src/server/db/base';
